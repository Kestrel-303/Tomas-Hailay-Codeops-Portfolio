...
Alex = Account("Alex", "Addis-1", 10000)
John = savings_account("John", "Addis-2", 5000, 3)
Berry = current_account("Berry", "Addis-3", 2000, 500)
...
print("\nDeposited 1000 to John and added interest. Withdrew 2500 from Berry.")
